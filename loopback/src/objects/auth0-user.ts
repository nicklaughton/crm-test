...
export class Auth0User extends ApexDataObject<Auth0User> {
    ...
    constructor(object?: any, options?: any, context?: any) {
        ...
        super(object, options, Auth0User, Auth0User._staticRepository, context);
    }
    ...
    static async create(
        ...
        return super.createWithChildren<Auth0User>(data, options, context);
    }
