...
@Component({
    selector: 'apex-refresh-button',
    templateUrl: './apex-refresh-button.component.html',
    styleUrls: ['./apex-refresh-button.component.scss'],
})
export class ApexRefreshButtonComponent implements OnInit, OnDestroy {
    /**Properties******************************************/
    ...
    setFixedWidth() {
        let debug = Debug('ApexRefreshButton:setFixedWidth');
