...
@Component({
    selector: 'apex-add-button',
    templateUrl: './apex-add-button.component.html',
    styleUrls: ['./apex-add-button.component.scss'],
})
export class ApexAddButtonComponent implements OnInit, OnDestroy {
    /**Properties******************************************/
    ...
    dump() {
        let debug = Debug('ApexAddButton:dump');
