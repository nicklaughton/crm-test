...
export class UserFormArray extends UserArray {
    ...
    constructor(arg1?: any, arg2?: any, arg3?: any) {
        if (
            ...
            arg1['isForms'] = true;
            arg1['classReference'] = UserFormGroup;
        } else if (!arg2)
            arg2 = { isForms: true, classReference: UserFormGroup };
        else {
            arg2['isForms'] = true;
            arg2['classReference'] = UserFormGroup;
        }
