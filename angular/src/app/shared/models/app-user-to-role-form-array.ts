...
import { AppUserToRoleFormGroup } from './app-user-to-role-form-group';

export class AppUserToRoleFormArray extends AppUserToRoleArray {
    ...
    constructor(arg1?: any, arg2?: any, arg3?: any) {
        if (
            ...
            arg1['isForms'] = true;
            arg1['classReference'] = AppUserToRoleFormGroup;
        } else if (!arg2)
            arg2 = { isForms: true, classReference: AppUserToRoleFormGroup };
        else {
            arg2['isForms'] = true;
            arg2['classReference'] = AppUserToRoleFormGroup;
        }
